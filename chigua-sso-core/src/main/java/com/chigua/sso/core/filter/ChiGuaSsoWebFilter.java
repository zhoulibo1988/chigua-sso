 ...
 */
public class ChiGuaSsoWebFilter extends HttpServlet implements Filter {
    private static Logger logger = LoggerFactory.getLogger(ChiGuaSsoWebFilter.class);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        ChiGuaSsoUser xxlUser = SsoWebLoginHelper.loginCheck(req, res);
