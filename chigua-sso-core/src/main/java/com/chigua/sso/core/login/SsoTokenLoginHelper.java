package com.chigua.sso.core.login;
...
public class SsoTokenLoginHelper {
     ...
     * @param xxlUser
     */
    public static void login(String sessionId, ChiGuaSsoUser xxlUser) {
     ...
     * @return
     */
    public static ChiGuaSsoUser loginCheck(String  sessionId){
        ...
        ChiGuaSsoUser xxlUser = SsoLoginStore.get(storeKey);
        if (xxlUser != null) {
     ...
     * @return
     */
    public static ChiGuaSsoUser loginCheck(HttpServletRequest request){
        String headerSessionId = request.getHeader(Conf.SSO_SESSIONID);
