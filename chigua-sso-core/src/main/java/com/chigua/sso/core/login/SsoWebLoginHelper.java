...
import com.chigua.sso.core.util.CookieUtil;
...
public class SsoWebLoginHelper {
     ...
     * @return
     */
    public static ChiGuaSsoUser loginCheck(HttpServletRequest request, HttpServletResponse response){

        String cookieSessionId = CookieUtil.getValue(request, Conf.SSO_SESSIONID);

        // cookie user
        ChiGuaSsoUser xxlUser = SsoTokenLoginHelper.loginCheck(cookieSessionId);
        if (xxlUser != null) {
            return xxlUser;
        }
